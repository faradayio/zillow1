# http://github.com/tfe/heroku_memcache/blob/master/init.rb
servers = ENV['MEMCACHE_SERVERS'].andand.split(',') || [ 'localhost:11211' ]
options = {
  :support_cas => true,
...
options[:namespace] = ENV['MEMCACHE_NAMESPACE'] if ENV['MEMCACHE_NAMESPACE']
